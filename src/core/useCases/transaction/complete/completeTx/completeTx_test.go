...
func TestTransactionService_CompleteAddTransaction(t *testing.T) {
	...
	service := NewCompleteTransactionTxService()
	...
	err := service.Complete(transactionID, transactionRepoTx, transactionStatusRepoTx, balanceProvisionRepoTx, accountRepoTx)
